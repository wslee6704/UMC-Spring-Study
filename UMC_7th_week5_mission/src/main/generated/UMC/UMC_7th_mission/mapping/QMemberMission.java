...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -58096763L;
    ...
    public final UMC.UMC_7th_mission.domain.QMission mission;

    public final EnumPath<UMC.UMC_7th_mission.domain.enums.MissionStatus> status = createEnum("status", UMC.UMC_7th_mission.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mission = inits.isInitialized("mission") ? new UMC.UMC_7th_mission.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
