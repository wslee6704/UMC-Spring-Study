...
public class QMemberPrefer extends EntityPathBase<MemberPrefer> {
    ...
    private static final long serialVersionUID = 1893010679L;
    ...
    public final UMC.UMC_7th_mission.domain.QFoodCategory foodCategory;
    ...
    public QMemberPrefer(Class<? extends MemberPrefer> type, PathMetadata metadata, PathInits inits) {
        ...
        this.foodCategory = inits.isInitialized("foodCategory") ? new UMC.UMC_7th_mission.domain.QFoodCategory(forProperty("foodCategory")) : null;
